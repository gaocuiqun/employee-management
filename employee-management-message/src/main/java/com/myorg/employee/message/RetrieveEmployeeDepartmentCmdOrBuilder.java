...
public interface RetrieveEmployeeDepartmentCmdOrBuilder extends
    // @@protoc_insertion_point(interface_extends:com.myorg.employee.message.RetrieveEmployeeDepartmentCmd)
